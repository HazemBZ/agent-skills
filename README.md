...
| [`project-pulse`](./project-pulse/SKILL.md) | Project-scoped monitoring and telemetry for phased delivery. Adds timestamps, event logs, webhook broadcasts, and export surfaces to `project_state.json` — enabling dashboards and cross-project visibility. | Sibling to `phase-tracking`. Use both for measurable delivery tracking, dashboards, alerts, and compliance. |
